        ...
        <div class="navbar-nav align-items-lg-center ml-auto">
            ...
            <div class="demo-navbar-user nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="javascript:" class="dropdown-item"> <i class="feather icon-settings text-muted"></i> &nbsp; Account settings</a>
                    <div class="dropdown-divider"></div>
                    <a href="#" class="dropdown-item" data-toggle="modal" data-target="#logoutModal"> <i class="feather icon-power text-danger"></i> &nbsp; Log Out</a>
                </div>
            </div>
        </div>
    </div>
