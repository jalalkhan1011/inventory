        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12 text-left">
                    <h6>Supplier</h6>
                    <p class="text-info">Create supplier</p>
                </div>
            </div>
            <hr>
            @if(session('message'))
            ...
            @endif
            <form action="{{ url('admin/suppliers') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="shop_name" value="{{ old('shop_name') }}" class="form-control" placeholder="Name" required/>
                        <div class="clearfix"></div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" name="mobile" minlength="11" maxlength="11" value="{{ old('mobile') }}" class="form-control" placeholder="Mobile" required/>
                        <div class="clearfix"></div>
