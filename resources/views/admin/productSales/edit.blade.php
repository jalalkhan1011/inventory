                ...
                <div class="form-row">
                    ...
                    <div class="col-md-12">
                        <table class="table table-bordered" id="productId">
                            ...
                            <tr class="rowFirst">
                                <input type="hidden" name="p_id[]" value="{{ $productSaleItem->product_id }}">
                                <input type="text" hidden name="u_p_q[]" value="{{ $productSaleItem->sale_qty}}">
                                <td>
                                ...
                                <td>
                                    <input type="number" name="stock_qty[]" step="0.01" value="{{ $productSaleItem->productStock->p_reduce_qty }}"  class="form-control stockQty" readonly>
                                </td>
                                <td>
