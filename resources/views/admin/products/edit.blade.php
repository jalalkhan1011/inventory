            ...
            <form action="{{ route('products.update',$product->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="code" value="{{ $product->code }}" class="form-control" placeholder="#p-1011" required readonly/>
                        <div class="clearfix"></div>
                        @if($errors->has('code'))
                            <span class="form-text">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="custom-select" name="category_id" required>
                            ...
                            @foreach($categories as $key => $category)
                                <option value="{{ $key }}"{{ $key == $selected_categories ? 'selected' : '' }}>{{ $category }}</option>
                            @endforeach
                        </select>
                        <div class="clearfix"></div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="custom-select" name="brand_id" required>
                            ...
                            @foreach($brands as $key => $brand)
                                <option value="{{ $key }}"{{ $key == $selected_brand ? 'selected' : '' }}>{{ $brand }}</option>
                            @endforeach
                        </select>
                        <div class="clearfix"></div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" name="purchase_date" class="form-control" value="{{ date('Y-m-d',strtotime($product->purchase_date)) }}" required>
                        <div class="clearfix">
                    ...
                    <div class="form-group col-md-6">
                        <label class="form-label">Purchase Date <span class="text-danger"> *</span></label>
                        <input type="date" name="expire_date" class="form-control" value="{{ date('Y-m-d',strtotime($product->expire_date)) }}" required>
                        <div class="clearfix">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" name="sale_price" id="sale_price" class="form-control" step="0.01" min = "1"   oninput="maxLengthCheck(this)" maxlength="5" value="{{ old('sale_price',$product->sale_price) }}" required>
                        <div class="clearfix">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" name="total_price" id="total_price" class="form-control" step="0.01" min = "1"   oninput="maxLengthCheck(this)" maxlength="5" value="{{ $product->total_price }}" placeholder="0.00" required readonly>
                        <div class="clearfix">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="custom-select" name="supplier_id" required>
                            ...
                            @foreach($suppliers as $key => $supplier)
                                <option value="{{ $key }}" {{ $key == $selected_supplier ? 'selected' : '' }}>{{ $supplier }}</option>
                            @endforeach
                        </select>
                        <div class="clearfix"></div>
                ...
                <div class="form-group">
                    ...
                    <textarea  name="description" class="form-control" placeholder="Write here" rows="10">{{ old('description',$product->description) }}</textarea>
                    <div class="clearfix"></div>
