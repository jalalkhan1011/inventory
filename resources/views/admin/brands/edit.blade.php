            ...
            <form action="{{ route('brands.update',$brand->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" name="name" value="{{ old('name',$brand->name) }}" class="form-control" placeholder="Name" required/>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea  name="description"  class="form-control" placeholder="Write here">{{ old('description',$brand->description) }}</textarea>
                        <div class="clearfix"></div>
