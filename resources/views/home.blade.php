                        ...
                        <div class="row no-gutters row-bordered row-border-light h-100">
                            ...
                            <div class="d-flex col-sm-6 col-md-4 col-lg-6 align-items-center">
                                <div class="card-body media align-items-center text-dark">
                                    ...
                                    <span class="media-body d-block ml-3">
                                                <span class="text-big"><span class="mr-1 text-danger">54</span> Tasks</span>
                                                <br />
                            ...
                            <div class="d-flex col-sm-6 col-md-4 col-lg-6 align-items-center">
                                <div class="card-body media align-items-center text-dark">
                                    ...
                                    <span class="media-body d-block ml-3">
                                                <span class="text-big"><span class="mr-1 text-success">6</span> Projects</span>
                                                <br />
                                    ...
                                    <div style="height: 330px;" id="tab-table-1">
                                        <table class="table table-hover card-table">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="media mb-0">
                                                        <img src="{{ asset('back-end/assets/img/avatars/3-small.png') }}" class="d-block ui-w-40 rounded-circle" alt="" />
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="media mb-0">
                                                        <img src="{{ asset('back-end/assets/img/avatars/1-small.png') }}" class="d-block ui-w-40 rounded-circle" alt="" />
                                                        <div class="media-body align-self-center ml-3">
